    ...
    <>
      ...
      <div className="flex flex-col h-screen  items-center ">
        <div className="text-center p-10 max-w-3xl w-full">
          <h1 className="text-5xl font-bold text-white">Query Page</h1>
          ...
          <div className="mt-4 flex justify-center">
            <form className="flex items-center" onSubmit={handleSearchSubmit}>
              ...
              <button
                type="submit"
                className="p-3 py-2 rounded-r-md font-semibold text-white border border-white hover:bg-slate-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-400"
              >
                Search
              </button>
            </form>
